      ...
      <div className="form">
        ...
        <div onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn block-cube block-cube-hover">
            ...
            <div className="text">{isSignUp ? 'Create Account' : 'Log In'}</div>
          </button>
          ...
          <div className="form-footer">
            ...
            <div>
              {isSignUp ? (
                <>Already have an account? <span className="link" onClick={() => setIsSignUp(false)}>Sign In</span></>
              ) : (
                <>New to ResMatch? <span className="link" onClick={() => setIsSignUp(true)}>Create Account</span></>
              )}
            </div>
          </div>
        </div>
